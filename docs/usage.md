...
First, prepare a samplesheet listing the different count datasets you want to use. Each row represents a specific dataset.
...
| ----------- | ------------------------------------------------------------------------------------- |
| `sample`    | Sample name                                                                           |
| `condition` | Condition corresponding to this sample (multiple samples possible for each condition) |
